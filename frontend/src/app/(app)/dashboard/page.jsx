...
import Calendar from '../../../components/dashboard/Calander';
...
const CoursePortal = () => {
  ...
  const DashboardView = () => (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="bg-gradient-to-r from-red-600 to-blue-600 rounded-2xl p-6 text-white shadow-lg">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold mb-2">
              Welcome back, {dashboardData.user.name}! 👋
            </h1>
            <p className="text-red-100">You're on fire! Keep the momentum going.</p>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="text-center bg-white/10 backdrop-blur-sm rounded-xl px-6 py-3">
              ...
              <div className="text-xs text-red-200">Day Streak</div>
            </div>
            ...
            <div className="text-center bg-white/10 backdrop-blur-sm rounded-xl px-6 py-3">
              ...
              <div className="text-xs text-red-200">Total XP</div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-red-50 rounded-2xl p-6 border-2 border-blue-200 shadow-md">
          ...
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <div className="w-full bg-gray-200 rounded-full h-2 mb-2">
                <div className="bg-gradient-to-r from-blue-500 to-red-500 h-2 rounded-full" style={{ width: '75%' }}></div>
              </div>
              <p className="text-sm text-gray-500">75% complete</p>
            </div>
            
            <button className="ml-6 px-8 py-3 bg-gradient-to-r from-blue-600 to-red-600 text-white rounded-xl font-semibold hover:from-blue-700 hover:to-red-700 transition-all duration-200 transform hover:scale-105 shadow-lg flex items-center gap-2">
              Continue
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {dashboardData.enrolledCourses.map((course) => (
            ...
            >
              <div className="relative overflow-hidden">
                ...
                <div className={`absolute inset-0 bg-gradient-to-t from-black/60 to-transparent transition-opacity duration-300 ${
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <button className="w-full py-2 bg-white text-red-600 rounded-lg font-semibold flex items-center justify-center gap-2">
                ...
                <div className="absolute top-3 left-3 flex gap-2">
                  ...
                  {course.newContent && (
                    <span className="bg-gradient-to-r from-red-500 to-pink-500 text-white px-3 py-1 rounded-full text-xs font-semibold animate-pulse">
                      New
                    </span>
                  )}
                </div>
              ...
              <div className="p-5">
                <h3 className="font-bold text-gray-900 mb-2 line-clamp-2 text-lg group-hover:text-red-600 transition-colors">
                  {course.title}
                </h3>
                ...
                <div className="mb-4">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
                    <div 
                      className="bg-gradient-to-r from-red-500 to-blue-500 h-2 rounded-full transition-all duration-700 ease-out"
      ...
      <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl p-6 border-2 border-yellow-200">
        ...
        <div className="grid grid-cols-3 gap-4">
          {[
            ...
            { title: 'Perfect Score', icon: Award, color: 'from-red-500 to-pink-500' }
    ...
    <div className="max-w-7xl mx-auto">
      <div className="bg-white rounded-xl shadow-md p-6 mb-8">
        ...
        <div className="flex items-center gap-6 mt-6">
          <button className="text-red-600 border-b-2 border-red-600 pb-3 font-semibold">
        ...
        {dashboardData.enrolledCourses.map((course) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <button className="w-full py-2 text-sm text-white bg-red-600 rounded-lg hover:bg-red-700 transition-colors font-medium">
                Continue
              </button>
            </div>
          </div>
